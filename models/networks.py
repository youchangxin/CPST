...
def define_D(input_nc, ndf, netD, n_layers_D=3, image_size=256, feature_dim=256, max_conv_dim=512, norm='batch',
             init_type='normal', init_gain=0.02, no_antialias=False, gpu_ids=[], opt=None):
    ...
    if netD == 'basic':  # default PatchGAN classifier
        net = NLayerDiscriminator(input_nc, ndf, n_layers=3, image_size=image_size, norm_layer=norm_layer,
        ...
        net = NCEDiscriminator(input_nc, ndf, n_layers=3, image_size=image_size, feature_dim=feature_dim,
                               max_conv_dim=max_conv_dim, norm_layer=norm_layer, no_antialias=no_antialias, )
    else:
