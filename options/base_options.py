...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='datasets/ChiP', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='cpst', help='name of the experiment. It decides where to store samples and models')
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='cpst', help='chooses which model to use.')
